...
- ✅ **電池供電**: 使用鋰聚電池（600-1500mAh），適合小型專案
- ✅ **智能充電**: TP4054 充電管理，電流可調（推薦 333mA）
- ✅ **自動切換**: P-MOSFET 理想二極體，USB/電池無縫切換（效率 >99%）
- ✅ **超長續航**: 目標續航 **3-6 個月**（1200mAh 電池，每日更新 2 次）
...
USB 5V (Type-C)
   │
   [W5 保留 USB 端] ←── SuperMini 改造：只斷開 VSYS 端
   │
   ├──> TP4054 充電 IC ──> 鋰電池 3.7V (600-1500mAh)
   │         │                  │
   │         └─ 控制 ──┐        │
   │                   ▼        │
   │            P-MOSFET (AO3401) 理想二極體
   │                   │
   └───────────────────┴──> SuperMini VSYS (系統主幹線)
                             │
                             ├──> ESP32-C3 供電
...
**新設計優勢** ✨:
- ✅ **保留 W5 保護**: 充電路徑 (USB → W5 → TP4054) 保持完整保護
- ✅ **高效供電路徑**: 電池供電 (電池 → AO3401 → VSYS) 繞過 W5，效率 >99%
- ✅ **簡化改造**: 只需斷開 W5 的 VSYS 端，可輕鬆恢復

### 核心設計

#### 1. TP4054 充電管理
- **充電電流**: 333mA（3kΩ 設定，適合 1200mAh 電池）
- **充電時間**: 約 3.6 小時（1200mAh ÷ 333mA）
- **充電截止**: 4.2V ±1%
